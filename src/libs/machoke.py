...
class Machoke:
    ...
    def __init__(self, binary, timeout, debug=False):
        '''
        timeout is False, or in seconds
        '''
        self.mmh3_line = ""
        self.machoke_line = ""
        self.error = False
    ...
    def timeout_handler(self, signum, frame):
        ...
        signal.alarm(0)
        raise Exception("machoke timeout.\n")
    ...
    def kill(self, message):
        ...
        FAIL = '\033[91m'
        ENDC = '\033[0m'
        sys.stderr.write(FAIL + "Machoke error: " + message + ENDC +"\n")
    ...
    def get_all_functions(self):
        ...
        try:
            func_list = json.loads(self.rdeux.cmd("aflj"))
        except ValueError:
            return None
...
#     '''
#     sys.stderr.write("MACHOKE main invoked (this shouldn't happen!!\n")
#     if not args.verbose:
#         null_stderr()
#     files = []
